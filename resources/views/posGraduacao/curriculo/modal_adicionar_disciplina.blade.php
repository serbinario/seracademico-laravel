        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" style="alignment-baseline: central">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn-floating pull-right" type="button" id="posgraduacaoAddDisciplina" title="Adicionar Disciplinas"><i class="material-icons">add_to_photos</i></button>
                        </div>
                    </div>
