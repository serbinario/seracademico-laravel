...
<div class="cabecalho">
    <h1>
        <img width="100" src="{{ asset('img/logo-alpha.png') }}" alt="alpha">
    </h1>
...
<div class="conteudo">
    ...
    <div style="margin-left: 5%; margin-top: 3%">
        ...
        <p>Matrícula recebida por :_____________________________________  Valor: R$___________</p>
    </div>
</div>

<div class="rodape" style="text-align: center; margin-top: 5%;">
    <p style="margin: 0;"><b>FACULDADE ALPHA</b></p>
