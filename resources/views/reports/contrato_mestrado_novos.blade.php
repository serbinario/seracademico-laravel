...
<div class="page" id= "page4" style="margin-left: 16%;">
    <div style="width: 700px;text-align: justify; font-size: 14px;position: relative; top:100px; ">
        ...
        13. O presente CONTRATO é firmado em duas vias, de igual teor e forma, assinado, neste ato, pelo CONTRATANTE e/ou RESPONSÁVEL FINANCEIRO e pela CONTRATADA.<br><br> 
