    ...
    <div id="body">
        <div class="page" id="page1">
            ...
            <table class="table">
                ...
                <tr>
                    <td colspan="4">Atenas College University</td>
                </tr>
                <tr>
                    <td colspan="4"><b>Endereço do escritório:</b> 200 Continental Drive, Suite 401, Newark, Delaware, 19713</td>
                </tr>
                <tr>
                    <td colspan="2"><b>Registro Estadual:</b> EIN 37-1838647</td>
                    <td colspan="2"><b>Inscrição Federal</b>: PI 5000094168</td>
                    

                </tr>
                <tr>
                    <td colspan="4">www.atenascollege.university</td>
                </tr>
            </table>
            ...
            <div style="width: 700px;text-align: justify; font-size: 14px; ">
                ...
                b) A contratada responsabiliza-se por contabilizar 100% das disciplinas que o contratante cursou na instituição onde cursava o mestrado, dando-se assim, a continuidade de seu curso sem perda acadêmica. Ressalta-se ainda, que a assinatura deste contrato anula o contrato assinado com a instituição anterior.<br>
                c) Desistência: é a demissão do aluno. Considera-se consumada quando este comunica à Contratada por escrito que deixa injustificadamente de participar das atividades acadêmicas. Acarreta para o desistente os deveres de pagar os montantes das prestações e dos preços vencidos e os deveres de reparar os prejuízos que causar à Contratada ou aos demais alunos da sua turma pela queda da sustentabilidade econômica do Curso.<br>
                d) Turma: é o grupamento formado pelo conjunto dos alunos devidamente matriculados para o Curso e que tem características assemelhadas a um “Condomínio de Compras” dos serviços da Contratada, com responsabilidades mútuas segundo este.<br><br>
...
<div class="page" id= "page2" style="margin-left: 16%;">
    ...
    <div style="width: 700px;text-align: justify; font-size: 14px;position: relative; top:100px;">
        ...
        c) Cursar disciplinas e/ou atividades do curso escolhido no cronograma, de acordo com o projeto pedagógico e matriz curricular estabelecidos, ficando a CONTRATADA desobrigada de reabrir disciplinas e/ou atividades quando o curso não estiver sendo oferecido ou quando a turma não estiver tendo aulas. 
        d) Atualizar seu endereço, e-mail e telefone junto à secretaria do curso, pois a CONTRATADA não se responsabilizará por extravio de correspondências ou falta de comunicação sobre possíveis alterações no decorrer do curso, nem por boletos que sejam enviados para endereços errados ou insuficientes. <br> <br>
...
<div class="page" id= "page3" style="margin-left: 16%;">
    ...
    <div style="width: 700px;text-align: justify; font-size: 14px;position: relative; top:150px; ">
        ...
        7. O presente CONTRATO tem início na data da sua assinatura, subsistindo até o término do curso escolhido pelo CONTRATANTE no QUADRO DE CONTRATAÇÃO. 
    </div>
</div>
<center>
    <hr id= "endpage3">
...
<div class="page" id= "page4" style="margin-left: 16%;">
    <div style="width: 700px;text-align: justify; font-size: 14px;position: relative; top:150px; ">
        ...
        11. O Curso foi concebido segundo os estudos de mercado e as experiências da Contratada. Para a sua manutenção depende das suas expectativas de sustentação do rateio dos seus custos e das naturais e previsíveis remunerações da Contratada. A perda de rendas poderá determinar a falta de condições para a sua manutenção. Por tais razões, fica o Contratante ciente de que iniciado o curso, caso no seu decorrer não haja número de alunos para assegurar a sua continuidade, será facultado ao Contratante, à sua livre escolha:
        a) Com as adequadas compensações econômicas dos respectivos custos, transferir-se para outro curso presentemente mantido em iguais condições pela Contratada;
        b) Com as necessárias adaptações aos custos então vigentes, ter sua vaga assegurada em outro curso idêntico a ser mantido pela Contratada;
        c) Aproveitar os seus créditos curriculares em quaisquer outros cursos mantidos pela Contratada, respeitadas as similitudes e equivalências de matérias;
        ...
        12. Fica eleito o foro da comarca de Brasília, Distrito Federal, para dirimir qualquer ação fundada no presente Contrato, renunciando as partes qualquer outro foro, por mais privilegiado que venha a ser. <br><br>

        13. O presente CONTRATO é firmado em duas vias, de igual teor e forma, assinado, neste ato, pelo CONTRATANTE e/ou RESPONSÁVEL FINANCEIRO e pela CONTRATADA.
