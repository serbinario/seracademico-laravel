...
<body>
    ...
    <div class="conteudo">
        <div id="conteudo_1" style="margin-top: 80px">
            ...
            <p style="text-align: justify">
                CURSO: ________________________________________ TURNO: ____________________________________
            </p>

            <br />

            <p style="text-align: justify">
                FONE: (___) _______________ E-MAIL: __________________________________________________________
            </p>
    ...
    <div class="rodape" style="margin-top: 32%;">
