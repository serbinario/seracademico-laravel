...
<body>
    ...
    <div class="conteudo">
        <div id="conteudo_1" style="margin-top: 80px">
            ...
            <p style="text-align: justify">
                CURSO: ______________________________________________________ TURNO: ___________________________________
            </p>

            <br />

            <p style="text-align: justify">
                FONE: (___) ______________________ E-MAIL: _____________________________________________________________
            </p>
