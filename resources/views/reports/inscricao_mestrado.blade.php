...
<div id="footer">
    <p>
        Matrícula de:_________ Data:_____/_____/______ Recebido por:____________________Valor: R$_______
    </p>

    <p>
        Assinatura do Aluno: ______________________________________________________________________
    </p>
</div>
