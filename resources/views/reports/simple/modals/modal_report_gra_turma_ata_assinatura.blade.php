                ...
                <div class="row">
                   <div class="col-md-12">
                       <div class="form-group">
                           ...
                           {!! Form::select('cursos', [], null, array('class' => 'form-control', 'id' => 'curso_gra_turma_ata_assinatura_id')) !!}
                       </div>

                       <div class="form-group">
                           {!! Form::label('turmas', 'Turmas') !!}
                           {!! Form::select('turmas', [], null, array('class' => 'form-control', 'id' => 'turma_gra_turma_ata_assinatura_id')) !!}
                       </div>

                       <div class="form-group">
                           {!! Form::label('disciplinas', 'Disciplinas') !!}
                           {!! Form::select('disciplinas', [], null, array('class' => 'form-control', 'id' => 'disciplina_gra_turma_ata_assinatura_id')) !!}
                       </div>
