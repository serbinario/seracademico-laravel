    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">card_travel</i> Relatórios de Devolução</h4>
            </div>
        ...
        <div class="ibox-content">
            ...
            {!! Form::open(['route'=>'seracademico.biblioteca.relatorioDeDevolucao', 'method' => "get", 'target' => '_blank']) !!}
