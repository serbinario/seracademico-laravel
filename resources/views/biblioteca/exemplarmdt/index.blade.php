    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">receipt</i> Listar Exemplares - Monografias/Dissertações/Teses</h4>
            </div>
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.biblioteca.createExemplarMonoDiTe')}}" class="btn-sm btn-primary pull-right">Novo Exemplar</a>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive no-padding">
                        <table id="exemplar-grid" class="display table table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>Acervo - Título</th>
                                <th>Cutter</th>
...
@section('javascript')
    <script type="text/javascript">
        var table = $('#exemplar-grid').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! route('seracademico.biblioteca.gridExemplarMonoDiTe') !!}",
            columns: [
