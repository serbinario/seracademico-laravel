...
@section('content')
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            @endif
            {!! Form::open(['route'=>'seracademico.biblioteca.storeExemplar','id' => 'FormExemplar', 'method' => "POST" , 'enctype' => 'multipart/form-data']) !!}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            function formatRepo2(repo) {
                ...
                var markup = '<option value="' + repo.id + '"><b>' + repo.id + ' - '+ repo.titulo + '</b><br />'+ repo.subtitulo +'<br />'+ repo.autor +'</option>';
                return markup;
            }
