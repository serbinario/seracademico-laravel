...
//echo ("$cidade, $semana, $dia de $mes de $ano");
    ...
    <body>
        <center><h3>BIBLIOTECA SUELANDRE GONSALVES LIMA
    ...
    <p class="termos">
        1)  Os livros sairão para empréstimo (mas as revistas, monografias, dissertações e teses só para consulta especial);
        2)  Aluno dos cursos técnicos poderá pegar até 02 (dois) livros, durante 3 (três) dias. O usuário que não for aluno da
        ALPHA, não poderá pegar livros para empréstimo e nem consulta;
        3)  Aluno da graduação poderá pegar até 02 (dois) livros, durante 08 (oito) dias; 
        4)  Aluno de pós-graduação, mestrado e doutorado poderá pegar 03 (três) livros e a consulta será apenas na biblioteca;
        5)  Funcionário poderá pegar até 03 (três) livros, durante 8 (oito) dias;
        6)  Professor poderá pegar até 03 (três) livros, durante 10 (dez) dias;
    ...
    <p class="termos">
        ...
        são para consulta exclusiva na biblioteca (consulta especial);</b>
    ...
    <p class="termos">
        ...
        a partir de 2019. <b>Só serão abonadas as multas em caso de doença mediante apresentação de atestado médico e/ou de acompanhamento;</b>
        ...
        <table border="0" style="border: none; width: 100%">
            <tr>
                ...
                <td style=" padding: 20px;width: 50%; font-size: 11px;">
                     <p style="position: absolute;top: 853px;left: 400px;z-index: -1;">
                        <img  src="{{ asset('biblioteca/img/assinatura_miriam_biblioteca.png') }}" alt="" style="width: 250px; height: auto;position: relative; top: -41px;">
                     </p>
             </td>
         </tr>
     </table>
    ...
    <div style="position: absolute;top: 880px;left: 35px; bottom:0;">
        <p>
         <img  src="{{ asset('img/assinatura_luciana_termo_biblioteca.png') }}" alt="" style="width: 280px; height: auto;position: relative; top: -41px;z-index: -2;">
     </p>
