    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">receipt</i> Editar Exemplar Periódico</h4>
            </div>
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($model, ['route'=> ['seracademico.biblioteca.updateExemplarP', $model->id], 'method' => "POST", 'enctype' => 'multipart/form-data' ]) !!}
