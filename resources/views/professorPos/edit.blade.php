...
@section('content')
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($model, ['route'=> ['seracademico.posgraduacao.professorpos.update', $model->id], 'id' => 'formProfessor', 'enctype' => 'multipart/form-data']) !!}
...
@section('javascript')
        <script src="{{ asset('/js/validacoes/validation_form_professor.js')}}"></script>
