    ...
    <div class="container">{{----}}
        <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">
                <!-- Dropdown Trigger -->
                <li><a href="{{ route('seracademico.portal.dashboard') }}">Principal</a></li>
                <li><a href="{{ route('seracademico.portal.academico') }}">Acadêmico</a></li>
                <li><a href="{{ route('seracademico.portal.financeiro') }}">Financeiro</a></li>
                <li><a href="{{ route('seracademico.portal.secretaria') }}">Secretaria</a></li>
