    ...
    <div class="modal-content">
        ...
        <div class="modal-body" style="alignment-baseline: central;">
            <div class="row">
                ...
                <div class="form-group col-md-6" style="position: relative; left:-10px;">
                    <label for="local_pagamento_editar">Local Pagamento</label>
                    <select class="form-control" name="local_pagamento_editar" id="local_pagamento_id">
                    </select>
                </div>
            </div>
