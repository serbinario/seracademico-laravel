...
@section('content')
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($aluno, ['route'=> ['seracademico.graduacao.aluno.update', $aluno->id], 'id' => 'formAluno', 'enctype' => 'multipart/form-data']) !!}
                @include('tamplatesForms.graduacao.tamplateFormAluno')
