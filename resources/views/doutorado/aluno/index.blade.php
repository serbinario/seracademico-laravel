        ...
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4>
                    ...
                    Listar Alunos de Doutorado
                </h4>
            </div>
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.doutorado.aluno.create')}}" class="btn-sm btn-primary pull-right">Novo Aluno</a>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <form id="search-form" class="form-inline" role="form" method="GET">
                        <div class="form-group">
                            {!! Form::select('cursoSearch', (['' => 'Todos os Cursos'] + $loadFields['doutorado\\curso']->toArray()), null, array('class' => 'form-control')) !!}
                        </div>

                        <div class="form-group">
                            {!! Form::select('turmaSearch', (['' => 'Todos as Turmas'] + $loadFields['doutorado\\turma']->toArray()), null, array('class' => 'form-control')) !!}
                        </div>
