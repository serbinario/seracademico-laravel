    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.doutorado.disciplina.create')}}" class="btn-sm btn-primary pull-right">Nova Disciplina</a>
            </div>
        </div>
...
@section('javascript')
    <script type="text/javascript">
        var table = $('#disciplina-grid').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{!! route('seracademico.doutorado.disciplina.grid') !!}",
            columns: [
