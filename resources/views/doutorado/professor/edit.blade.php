...
@section('content')
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {!! Form::model($model, ['route'=> ['seracademico.doutorado.professor.update', $model->id], 'id' => 'formProfessor', 'enctype' => 'multipart/form-data']) !!}
                @include('tamplatesForms.doutorado.tamplateFormProfessor')
