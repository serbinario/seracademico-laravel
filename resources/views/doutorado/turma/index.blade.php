...
@section('content')
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.doutorado.turma.create')}}" class="btn-sm btn-primary pull-right">Nova Turma</a>
            </div>
        </div>
    ...
    @include('doutorado.turma.modal_calendario')
    @include('doutorado.turma.modal_novo_calendario')
    @include('doutorado.turma.modal_editar_calendario')
    @include('doutorado.turma.modal_incluir_disciplinas')
    @include('doutorado.turma.modal_notas')
    @include('doutorado.turma.modal_editar_notas')
    @include('doutorado.turma.modal_frequencias')
    @include('doutorado.turma.alunos.modal_turmas_alunos')
    @include('doutorado.turma.alunos.modal_add_aluno')
    @include('doutorado.turma.diarioAula.modal_diario_aula')
    @include('doutorado.turma.diarioAula.modal_create_diario_aula')
    @include('doutorado.turma.diarioAula.modal_edit_diario_aula')
...
@section('javascript')
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_calendario.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_novo_calendario.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_editar_calendario.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_incluir_disciplinas.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_notas.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_editar_notas.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/modal_frequencias.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/alunos/modal_turmas_alunos.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/alunos/modal_add_aluno.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/modal_diario_aula.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/modal_create_diario_aula.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/modal_edit_diario_aula.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/conteudo_programatico_create.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/conteudo_programatico_edit.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/diarioAula/diario_aula_select2.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/doutorado/turma/planoEnsino/modal_plano_ensino.js')  }}"></script>
    <script type="text/javascript" src="{{ asset('/js/report/simple/modal_report_doutorado_turma_ata_assinatura.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/js/report/simple/modal_report_doutorado_turma_ata_aniversariantes.js') }}"></script>
    <script type="text/javascript" src="{{ asset('/js/report/simple/modal_report_doutorado_aluno_turma.js') }}"></script>
    <script type="text/javascript">
        var table = $('#turma-grid').DataTable({
            ...
            ajax: "{!! route('seracademico.doutorado.turma.grid') !!}",
            columns: [
