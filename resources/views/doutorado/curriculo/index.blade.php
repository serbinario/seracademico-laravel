...
@section('content')
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-title">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.doutorado.curriculo.create')}}" class="btn-sm btn-primary pull-right">Novo Curriculo</a>
            </div>
        </div>
    ...
    @include('reports.simple.modals.modal_report_doutorado_curriculo_disciplina')
@stop

@section('javascript')
    <script type="text/javascript" src="{{ asset('/js/report/simple/modal_report_dou_curriculo_disciplina.js') }}"></script>
    <script type="text/javascript">
        ...
        var table = $('#curriculo-grid').DataTable({
            ...
            serverSide: true,
            autoWidth: false,
            ajax: "{!! route('seracademico.doutorado.curriculo.grid') !!}",
            columns: [
...
//                {data: 'valido_fim', name: 'fac_curriculos.valido_fim'},
        ...
        $(document).on("click", '.grid-curricular', function () {
            ...
            table2 = $('#disciplina-grid').DataTable({
                ...
                iDisplayLength: 5,
                bLengthChange: false,
                ajax: "/index.php/seracademico/doutorado/curriculo/gridByCurriculo/" + idCurriculo,
                columns: [
            ...
            table2.ajax.url("/index.php/seracademico/doutorado/curriculo/gridByCurriculo/" + idCurriculo).load();
        });
        ...
        $(document).on('click', '#addDisciplina', function (event) {
            ...
            jQuery.ajax({
                type: 'POST',
                url: '{{ route('seracademico.doutorado.curriculo.adicionarDisciplinas')  }}',
                headers: {
                    'X-CSRF-TOKEN': '{{  csrf_token() }}'
                },
                data: dados,
        ...
        $(document).on('click', '.removerDisciplina', function () {
            ...
            jQuery.ajax({
                type: 'POST',
                url: '{{ route('seracademico.doutorado.curriculo.removerDisciplina')  }}',
                headers: {
                    'X-CSRF-TOKEN': '{{  csrf_token() }}'
                },
                data: dados,
