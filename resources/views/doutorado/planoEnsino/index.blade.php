    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.doutorado.planoensino.create')}}" class="btn-sm btn-primary pull-right">Novo Plano de Ensino</a>
            </div>
        </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        var table = $('#fac_plano_ensino').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{!! route('seracademico.doutorado.planoensino.grid') !!}",
            columns: [
                {data: 'nome', name: 'nome'},
