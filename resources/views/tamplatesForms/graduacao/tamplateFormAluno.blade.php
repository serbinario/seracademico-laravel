<div class="row">
    ...
    <div class="col-md-2" >
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <div class="fileinput-preview thumbnail" id="captura" data-trigger="fileinput" style="width: 135px; height: 115px;">
                @if (isset($aluno) && $aluno->path_image != null)
                    <div id="midias">
                        <img id="logo" src="{{route('seracademico.graduacao.aluno.getImgAluno', ['id' => $aluno->id])}}"  alt="Foto" height="120" width="100"/><br/>
                    </div>
                @endif
            </div>
            <div>
