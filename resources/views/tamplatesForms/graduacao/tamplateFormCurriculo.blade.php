	...
	<div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @if(isset($model) && count($model->disciplinas) > 0)
                        {!! Form::select('curso_id', $loadFields['graduacao\\curso'] , null, array('class' => 'form-control', 'disabled'=>'disabled')) !!}
                    @else
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="btn-group">
                <a href="{{ route('seracademico.graduacao.curriculo.index') }}" class="btn btn-primary btn-block"><i class="fa fa-long-arrow-left"></i>  Voltar</a></div>
                <div class="btn-group">
