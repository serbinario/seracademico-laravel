                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                @if(isset($model->pessoa->endereco->bairro->cidade->id))
                                    {!! Form::select('cidade', array($model->pessoa->endereco->bairro->cidade->id => $model->pessoa->endereco->bairro->cidade->nome),
                                    $model->pessoa->endereco->bairro->cidade->id,array('class' => 'form-control', 'id' => 'cidade')) !!}
                                @else
                            ...
                            <div class="form-group col-md-3">
                                ...
                                @if(isset($model->pessoa->endereco->bairro->id))
                                    {!! Form::select('pessoa[endereco][bairros_id]', array($model->pessoa->endereco->bairro->id => $model->pessoa->endereco->bairro->nome),
                                    $model->pessoa->endereco->bairro->id,array('class' => 'form-control', 'id' => 'bairro')) !!}
                                @else
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <a href="{{ route('seracademico.tecnico.professor.index') }}" class="btn btn-primary"><i
