        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
					...
					{!! Form::select('disciplina_id', (['' => 'Selecione uma disciplina'] + $loadFields['mestrado\\disciplina']->toArray()), NULL, array('class' => 'form-control')) !!}
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <a href="{{ route('seracademico.mestrado.planoEnsino.index') }}" class="btn btn-primary"><i class="fa fa-long-arrow-left"></i>  Voltar</a>
            </div>
            <div class="btn-group">
