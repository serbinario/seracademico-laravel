	...
	<div class="col-md-12">
		<div class="row">
            <div class="col-md-4">
                ...
                @if(isset($model->curriculo->curso->id))
				    {!! Form::select('curso_id', $loadFields['mestrado\\curso'], $model->curriculo->curso->id, array('class' => 'form-control')) !!}
                @else
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="btn-group">
                <a href="{{ route('seracademico.mestrado.turma.index') }}" class="btn btn-primary btn-block pull-right"><i class="fa fa-long-arrow-left"></i>   Voltar</a></div>
                <div class="btn-group">
