...
<div class="row">
    <div class="col-md-12">
        ...
        https://www.youtube.com/watch?v=4Cz4KNZHot4

        https://www.youtube.com/watch?v=eXcMD2pbeWc
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <a href="{{ route('seracademico.posgraduacao.aluno.index') }}" class="btn btn-primary btn-block pull-right">Voltar</a>
        </div>
    </div>
