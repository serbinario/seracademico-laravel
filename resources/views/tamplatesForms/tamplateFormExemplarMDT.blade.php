        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="dado">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            {!! Form::label('responsaveis_id', 'Orientador') !!}
            ...
            <div role="tabpanel" class="tab-pane" id="outros">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('numero_pag', 'Número de folhas') !!}
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="btn-group btn-group-justified">
            <div class="btn-group">
                <a href="{{ route('seracademico.biblioteca.indexExemplarMonoDiTe') }}" class="btn btn-primary btn-block"><i
