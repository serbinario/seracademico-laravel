	...
	<div class="col-md-12">
		<div class="row">
            <div class="col-md-4">
                ...
                @if(isset($model->curriculo->curso->id))
				    {!! Form::select('curso_id', $loadFields['doutorado\\curso'], $model->curriculo->curso->id, array('class' => 'form-control')) !!}
                @else
                    {!! Form::select('curso_id', $loadFields['doutorado\\curso'], null, array('class' => 'form-control')) !!}
                @endif
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="btn-group">
                <a href="{{ route('seracademico.doutorado.turma.index') }}" class="btn btn-primary btn-block pull-right"><i class="fa fa-long-arrow-left"></i>   Voltar</a></div>
                <div class="btn-group">
...
@section('javascript')
    ...
    {{--Regras de validação--}}
    {{--<script type="text/javascript" src="{{ asset('/js/validacoes/doutorado/turma.js')  }}"></script>--}}
@stop
