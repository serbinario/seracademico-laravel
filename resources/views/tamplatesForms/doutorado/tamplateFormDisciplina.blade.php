        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="{{ route('seracademico.doutorado.disciplina.index') }}" class="btn btn-primary btn-block"> <i class="fa fa-long-arrow-left"></i>  Voltar</a>
                    </div>
                    <div class="btn-group">
...
@section('javascript')
    ...
    --}}{{--Regras de validação--}}{{--
    <script type="text/javascript" src="{{ asset('/js/validacoes/doutorado/disciplinaValidator.js')  }}"></script>--}}
@stop