...
class BuildersExtraCurricular
{
    ...
    {
        # Retorno
        return \DB::table('fac_alunos_semestres_equivalencias')
            ->join('fac_disciplinas', 'fac_disciplinas.id', '=', 'fac_alunos_semestres_equivalencias.disciplina_equivalente_id')    
            ->leftjoin('fac_tipo_disciplinas', 'fac_disciplinas.tipo_disciplina_id', '=', 'fac_tipo_disciplinas.id')
            ->join('fac_curriculos', 'fac_curriculos.id', '=', 'fac_alunos_semestres_equivalencias.curriculo_id')
            ->join('fac_curriculo_disciplina', function ($join) {
                $join->on('fac_curriculo_disciplina.curriculo_id', '=', 'fac_curriculos.id')
                    ->on('fac_curriculo_disciplina.disciplina_id', '=', 'fac_disciplinas.id');
            })
            ...
            ->join('fac_disciplinas as equivalente', 'equivalente.id', '=', 'fac_alunos_semestres_equivalencias.disciplina_id')
            ->join('fac_curriculo_disciplina as curriculoDisciplinEquivalente', function ($join) {
               $join->on('curriculoDisciplinEquivalente.curriculo_id', '=', 'fac_alunos_cursos.curriculo_id')
                    ->on('curriculoDisciplinEquivalente.disciplina_id', '=', 'equivalente.id');
            })
            ->join('fac_curriculos as curriculoEquivalente', 'curriculoEquivalente.id', '=', 'fac_alunos_cursos.curriculo_id')
            ->join('fac_cursos', 'fac_cursos.id', '=', 'curriculoEquivalente.curso_id')
            ->join('pessoas', 'pessoas.id', '=', 'fac_alunos.pessoa_id')
            ->whereNotIn('fac_disciplinas.id', function ($query) use ($idAluno) {
                $query->from('fac_alunos_notas')
                    ->distinct()
            ...
            ->select([
                ...
                'fac_disciplinas.qtd_falta',
                'fac_disciplinas.qtd_credito',
                'curriculoDisciplinEquivalente.periodo',
                'fac_tipo_disciplinas.nome as tipo_disciplina',
                'pessoas.nome as nomeAluno',
                'fac_cursos.nome as nomeCurso',
                \DB::raw('IF(pre1.codigo != "", pre1.codigo, "Não Informado") as pre1Codigo'),
     ...
     * @return mixed
     */
    public static function getEquivalenciaCursando($idAluno) {
        # Retorno
        return \DB::table('fac_alunos_semestres_equivalencias')
            ->join('fac_disciplinas', 'fac_disciplinas.id', '=', 'fac_alunos_semestres_equivalencias.disciplina_equivalente_id')
            ->leftjoin('fac_tipo_disciplinas', 'fac_disciplinas.tipo_disciplina_id', '=', 'fac_tipo_disciplinas.id')
     ...
     * @return mixed
     */
    public static function getEquivalenciaMatricular($idAluno) {
        # Retorno
        return \DB::table('fac_alunos_semestres_equivalencias')
            ->join('fac_disciplinas', 'fac_disciplinas.id', '=', 'fac_alunos_semestres_equivalencias.disciplina_equivalente_id')    
            ->leftjoin('fac_tipo_disciplinas', 'fac_disciplinas.tipo_disciplina_id', '=', 'fac_tipo_disciplinas.id')
