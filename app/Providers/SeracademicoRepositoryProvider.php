...
class SeracademicoRepositoryProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(
            \Seracademico\Repositories\Graduacao\VestibulandoDocumentoRepository::class,
            \Seracademico\Repositories\Graduacao\VestibulandoDocumentoRepositoryEloquent::class
        );
        ...
        $this->app->bind(
            \Seracademico\Repositories\Tecnico\ModuloRepository::class,
            \Seracademico\Repositories\Tecnico\ModuloRepositoryEloquent::class
        );
        ...
        */
        ...
        $this->app->bind(
            \Seracademico\Repositories\Financeiro\CarneRepository::class,
            \Seracademico\Repositories\Financeiro\CarneRepositoryEloquent::class
        );
        ...
        $this->app->bind(
            \Seracademico\Repositories\Tecnico\AgendamentoAlunoRepository::class,
            \Seracademico\Repositories\Tecnico\AgendamentoAlunoRepositoryEloquent::class
        );

        $this->app->bind(
            \Seracademico\Repositories\Vestibular\VestibularAgendamentoRepository::class,
            \Seracademico\Repositories\Vestibular\VestibularAgendamentoRepositoryEloquent::class
        );
