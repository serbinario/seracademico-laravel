...
class VestibulandoValidator extends LaravelValidator
{
    ...
    protected $attributes = [
        ...
        'pessoa.cpf' => 'CPF',
        'pessoa.data_nasciemento' => 'Data Nasciemento',
        'primeira_opcao_curso_id' => '1º Opção ',
        'primeira_opcao_turno_id' => 'Opção Turno',
...
//        'pessoa.email' => 'email|max:50|unique:fac_alunos,email',
...
//        'pessoa.celular2' => 'digits_between:9,11|numeric',
    ...
    protected $rules = [
        ValidatorInterface::RULE_CREATE => [
            ...
            'pessoa.nome' => 'required|max:60|serbinario_alpha_space',
