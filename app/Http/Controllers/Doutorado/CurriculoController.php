...
use Seracademico\Services\Doutorado\CurriculoService;
...
class CurriculoController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        # Retorno para view
        return view('doutorado.curriculo.index', compact('loadFields'));
    }
    ...
    public function grid()
    {
        ...
        $rows = \DB::table('fac_curriculos')
            ...
            ->where('fac_curriculos.tipo_nivel_sistema_id', 5)
            ->select([
                'fac_curriculos.id',
                'fac_curriculos.nome',
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.curriculo.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
           ...
           // $aluno = $this->service->getAlunoWithDateFormatPtBr($aluno);
            ...
            #retorno para view
            return view('doutorado.curriculo.edit', compact('model', 'loadFields'));
