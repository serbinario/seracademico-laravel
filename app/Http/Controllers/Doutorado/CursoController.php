...
use Seracademico\Services\Doutorado\CursoService;
use Yajra\Datatables\Datatables;
use Prettus\Validator\Exceptions\ValidatorException;
use Prettus\Validator\Contracts\ValidatorInterface;
use Seracademico\Validators\Doutorado\CursoValidator;
...
class CursoController extends Controller
{
    ...
    */
    ...
    {
        return view('doutorado.curso.index');
    }
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.curso.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
           ...
           // $aluno = $this->service->getAlunoWithDateFormatPtBr($aluno);
            ...
            #retorno para view
            return view('doutorado.curso.edit', compact('model', 'loadFields'));
