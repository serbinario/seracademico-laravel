...
use Seracademico\Services\Doutorado\DisciplinaService;
use Yajra\Datatables\Datatables;
use Prettus\Validator\Exceptions\ValidatorException;
use Prettus\Validator\Contracts\ValidatorInterface;
use Seracademico\Validators\Doutorado\DisciplinaValidator;
...
class DisciplinaController extends Controller
{
    ...
    */
    ...
    {
        return view('doutorado.disciplina.index');
    }
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.disciplina.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
           ...
           // $aluno = $this->service->getAlunoWithDateFormatPtBr($aluno);
            ...
            #retorno para view
            return view('doutorado.disciplina.edit', compact('model', 'loadFields'));
