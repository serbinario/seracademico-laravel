...
use Seracademico\Validators\Doutorado\TurmaValidator;
...
class TurmaController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        #retorno
        return view('doutorado.turma.index', compact('loadFields'));
    }
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.turma.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('doutorado.turma.edit', compact('model', 'loadFields'));
