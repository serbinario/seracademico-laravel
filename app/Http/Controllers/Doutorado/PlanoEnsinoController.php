...
use Seracademico\Validators\Doutorado\PlanoEnsinoValidator;
use Seracademico\Http\Controllers\Controller;
use Seracademico\Services\Doutorado\PlanoEnsinoService;
...
class PlanoEnsinoController extends Controller
{
    ...
    */
    private $loadFields = [
        'Doutorado\\Disciplina|doutorado'
    ];
    ...
    */
    ...
    {
        return view('doutorado.planoEnsino.index');
    }
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.planoEnsino.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('doutorado.planoEnsino.edit', compact('model', 'loadFields'));
