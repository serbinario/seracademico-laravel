...
use Seracademico\Validators\Doutorado\AlunoValidator;
...
class AlunoController extends Controller
{
    ...
    private $loadFields = [
        ...
        'Doutorado\\Curso|byCurriculoAtivo,1',
    ];
    ...
    public function index()
    {
        try {
            ...
            # retorno
            return view('doutorado.aluno.index', compact('loadFields'));
        } catch (\Throwable $e) {
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('doutorado.aluno.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('doutorado.aluno.edit', compact('aluno', 'loadFields'));
        } catch (\Throwable $e) {
            return redirect()->back()->with('message', $e->getMessage());
        }
    }
