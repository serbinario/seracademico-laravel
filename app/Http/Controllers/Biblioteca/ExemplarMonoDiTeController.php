...
use Seracademico\Services\Biblioteca\ExemplarMonoDiTeService;
use Yajra\Datatables\Datatables;
use Prettus\Validator\Exceptions\ValidatorException;
use Prettus\Validator\Contracts\ValidatorInterface;
use Seracademico\Validators\Biblioteca\ExemplarMonoDiTeValidator;

class ExemplarMonoDiTeController extends Controller
{
    /**
    * @var ExemplarMonoDiTeService
    */
    private $service;

    /**
    * @var ExemplarMonoDiTeValidator
    */
    private $validator;
    ...
    /**
    * @param ExemplarMonoDiTeService $service
    * @param ExemplarMonoDiTeValidator $validator
    */
    public function __construct(ExemplarMonoDiTeService $service,
                                ExemplarMonoDiTeValidator $validator)
    {
    ...
    {
        return view('biblioteca.exemplarmdt.index');
    }
    ...
    public function grid()
    {
        ...
        return Datatables::of($rows)->addColumn('action', function ($row) {
            $html       = '<div class="fixed-action-btn horizontal">
                            ...
                            <ul>
                            <li><a class="btn-floating" href="editExemplarMonoDiTe/'.$row->id.'" title="Editar disciplina"><i class="material-icons">edit</i></a></li>
           ...
           if(count($emprestimo->emprestimos) == 0) {
                $html .= '<li><a class="btn-floating excluir" href="deleteExemplarMonoDiTe/'.$row->id.'" title="Excluir disciplina"><i class="material-icons">delete</i></a></li>
                            </ul>
                           </div>';
           }
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('biblioteca.exemplarmdt.create', compact('loadFields', 'acervo'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('biblioteca.exemplarmdt.edit', compact('model', 'loadFields', 'acervo'));
