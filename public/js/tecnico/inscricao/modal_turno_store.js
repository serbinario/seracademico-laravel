...
function loadFieldsTurno()
{
    ...
    var dados =  {
        'models' : [
            'Turno|uniqueVestibularCurso,' + idInscricaoCurso
        ]
    };
    ...
    jQuery.ajax({
        type: 'POST',
        data: dados,
        url: '/index.php/seracademico/tecnico/inscricao/curso/turno/getLoadFields',
        datatype: 'json'
...
$('#btnSalvarCursoTurno').click(function() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/tecnico/inscricao/curso/turno/store',
        data: dados,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
