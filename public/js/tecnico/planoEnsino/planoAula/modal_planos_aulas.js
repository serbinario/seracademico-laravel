...
function loadTablePlanoAula (idPlanoEnsino) {
    tablePlanoAula = $('#grid-planos-aulas').DataTable({
        ...
        bFilter: false,
        autoWidth: false,
        ajax: "/index.php/seracademico/mestrado/planoEnsino/planoAula/grid/" + idPlanoEnsino,
        columns: [
            // {
...
function runPlanoAula(idPlanoEnsino) {
    ...
    if(tablePlanoAula) {
        loadTablePlanoAula(idPlanoEnsino).ajax.url("/index.php/seracademico/mestrado/planoEnsino/planoAula/grid/" + idPlanoEnsino).load();
    } else {
...
$(document).on('click', '#btnDestroyPlanoAula', function () {
    ...
    jQuery.ajax({
        type: 'DELETE',
        url: '/index.php/seracademico/mestrado/planoEnsino/planoAula/delete/' + idPlanoAula,
        datatype: 'json'
