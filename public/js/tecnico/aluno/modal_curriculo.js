...
$('#modal-curriculo').on('hidden.bs.modal', function () {
    loadTableDisciplinasACursar(0).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridACursar/" + 0).load();
    loadTableDisciplinasCursadas(0).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridCursadas/" + 0).load();
})
...
function loadTableDisciplinasACursar(idAlunoTurma) {
    tableDisciplinasACursar = $('#grid-acursar').DataTable({
        ...
        //bFilter: false,
        //bPaginate: false,
        ajax: "/index.php/seracademico/tecnico/aluno/curriculo/gridACursar/" + idAlunoTurma,
        columns: [
...
function loadTableDisciplinasCursadas(idAlunoTurma) {
    tableDisciplinasCursadas = $('#grid-cursadas').DataTable({
        ...
        //bFilter: false,
        //bPaginate: false,
        ajax: "/index.php/seracademico/tecnico/aluno/curriculo/gridCursadas/" + idAlunoTurma,
        columns: [
...
function loadTableDisciplinasDispensadas(idAlunoTurma) {
    tableDisciplinasDispensadas = $('#grid-dispensadas').DataTable({
        ...
        bFilter: false,
        //bPaginate: false,
        ajax: "/index.php/seracademico/tecnico/aluno/curriculo/gridDispensadas/" + idAlunoTurma,
        columns: [
            {data: 'disciplina_codigo', name: 'fac_disciplinas.codigo', orderable: false, searchable: false},
            {data: 'disciplina_nome', name: 'fac_disciplinas.nome', orderable: false, searchable: false},
...
function loadTableDisciplinasExtraCurricular (idAluno) {
    tableDisciplinasExtraCurricular = $('#grid-extras').DataTable({
        ...
        bFilter: false,
        autoWidth: false,
        ajax: "/index.php/seracademico/tecnico/aluno/curriculo/gridDisciplinasExtraCurricular/" + idAluno,
        columns: [
...
function loadTableDisciplinasEquivalentes (idAluno) {
    tableDisciplinasEquivalentes = $('#grid-equivalencias').DataTable({
        ...
        bFilter: false,
        autoWidth: false,
        ajax: "/index.php/seracademico/tecnico/aluno/curriculo/gridDisciplinasEquivalentes/" + idAluno,
        columns: [
            {data: 'disciplina_codigo', name: 'fac_disciplinas.codigo'},
            {data: 'carga_horaria', name: 'fac_disciplinas.carga_horaria'},
            {data: 'qtd_credito', name: 'fac_disciplinas.qtd_credito'},
...
function runCurriculo(idAluno) {
    ...
    if(tableDisciplinasACursar) {
        loadTableDisciplinasACursar(idAluno).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridACursar/" + idAluno).load();
    } else {
    ...
    if(tableDisciplinasCursadas) {
        loadTableDisciplinasCursadas(idAluno).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridCursadas/" + idAluno).load();
    } else {
    ...
    if(tableDisciplinasDispensadas) {
        loadTableDisciplinasDispensadas(idAluno).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridDispensadas/" + idAluno).load();
    } else {
    ...
    if(tableDisciplinasExtraCurricular) {
        loadTableDisciplinasExtraCurricular(idAluno).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridDisciplinasExtraCurricular/" + idAluno).load();
    } else {
    ...
    if(tableDisciplinasEquivalentes) {
        loadTableDisciplinasEquivalentes(idAluno).ajax.url("/index.php/seracademico/tecnico/aluno/curriculo/gridDisciplinasEquivalentes/" + idAluno).load();
    } else {
