...
function loadFieldsDebitoEditar()
{
    ...
    jQuery.ajax({
        type: 'GET',
        data: dados,
        url: '/index.php/seracademico/doutorado/aluno/financeiro/getLoadFields',
        datatype: 'json'
...
function builderHtmlFieldsDebitoEditar (dados) {
    jQuery.ajax({
        type: 'GET',
        url: '/index.php/seracademico/doutorado/aluno/financeiro/getDebito/' + idDebito,
        datatype: 'json'
    }).done(function (retorno) {
        if (retorno.success) {
            var htmlTaxa = "";
...
$('#btnUpdateDebito').click(function() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/doutorado/aluno/financeiro/updateDebito/' + idDebito,
        data: dados,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
