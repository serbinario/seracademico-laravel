...
$(document).on("click", "#btnEditDiarioAula", function () {
    ...
    if(tableConteudoProgramaticoDiarioAulaEdit) {
        loadTableConteudoProgramaticoDiarioAulaEdit().ajax.url("/index.php/seracademico/doutorado/turma/diarioAula/gridConteudoProgramatico/" + idDiarioAula).load();
    } else {
...
function builderHtmlFieldsDiarioAulaEditar (dados) {
    ...
    jQuery.ajax({
        type: 'GET',
        url: '/index.php/seracademico/doutorado/turma/diarioAula/edit/' + idDiarioAula,
        datatype: 'json'
    }).done(function (retorno) {
        if (retorno.success) {
            //Limpando os campos
...
$('#btnUpdateDiarioAula').click(function() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/doutorado/turma/diarioAula/update/' + idDiarioAula,
        data: dados,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
