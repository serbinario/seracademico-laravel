...
function loadTableFrequencias (idTurma) {
    tableFrequencias = $('#frequencias-grid').DataTable({
        ...
        bPaginate: false,
        ajax: {
            url: "/index.php/seracademico/doutorado/turma/frequencias/grid/" + idTurma,
            data: function (d) {
...
function runTableFrequencias(idTurma) {
    if (tableFrequencias) {
        tableFrequencias.ajax.url( "/index.php/seracademico/doutorado/turma/frequencias/grid/" + idTurma).load();
    } else {
...
function loadFieldsFrequencias()
{
    ...
    jQuery.ajax({
        type: 'POST',
        data: dados,
        url: '/index.php/seracademico/doutorado/turma/frequencias/getLoadFields',
        datatype: 'json'
...
$(document).on('click', '.frequencia', function () {
    ...
    jQuery.ajax({
        type: 'PUT',
        url: '/index.php/seracademico/doutorado/turma/frequencias/changeFrequencia/' + idFrequencia,
