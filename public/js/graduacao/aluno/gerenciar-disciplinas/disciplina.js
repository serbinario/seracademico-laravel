...
function loadTableDisciplina(idAluno, idSemestre)
{
    ...
    tableDisciplina = $('#disciplina-grid').on( 'init.dt', function ( e, settings, data ) {
        ...
        autoWidth: false,
        retrieve: true,
        ajax: "/index.php/seracademico/graduacao/aluno/semestre/gridDisciplina/" + idAluno,
        columns: [
...
$(document).on('click', '#disciplina-grid tbody tr', function () {
    ...
    jQuery.ajax({
        type: 'POST',
        data: {"dados" : arrayId},
        url: '/index.php/seracademico/graduacao/aluno/semestre/getTurmasHorarios/' + idSemestre,
        datatype: 'json'
        ...
        if(retorno.success) {
            ...
            zTreeObj = $.fn.zTree.init($("#gerenciamento-disciplina-ztree"), setting, zNodes);
        } else {
