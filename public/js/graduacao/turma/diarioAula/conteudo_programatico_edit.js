...
function loadTableConteudoProgramaticoDiarioAulaEdit() {
    ...
    tableConteudoProgramaticoDiarioAulaEdit = $('#conteudo-programatico-diario-aula-grid-edit').DataTable({
        ...
        bFilter: false,
        autoWidth: false,
        ajax: "/index.php/seracademico/graduacao/turma/diarioAula/gridConteudoProgramatico/" + idDiarioAula,
        columns: [
            {data: 'nome', name: 'nome'},
...
$('#btnAddConteudoProgramaticoDiarioAulaEdit').on( 'click', function () {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/graduacao/turma/diarioAula/attachConteudo/' + idDiarioAula,
...
$(document).on( 'click', '#btnRemoverConteudoProgramaticoDiarioAulaEditar', function () {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/graduacao/turma/diarioAula/detachConteudo/' + idDiarioAula,
