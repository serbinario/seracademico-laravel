...
$(document).on("click", "#btnEditDiarioAula", function () {
    ...
    if(tableConteudoProgramaticoDiarioAulaEdit) {
        loadTableConteudoProgramaticoDiarioAulaEdit().ajax.url("/index.php/seracademico/graduacao/turma/diarioAula/gridConteudoProgramatico/" + idDiarioAula).load();
    } else {
...
function loadFieldsDiarioAulaEditar()
{
    ...
    jQuery.ajax({
        type: 'GET',
        data: dados,
        url: '/index.php/seracademico/graduacao/turma/diarioAula/getLoadFields',
        datatype: 'json'
...
function builderHtmlFieldsDiarioAulaEditar (dados) {
    ...
    jQuery.ajax({
        type: 'GET',
        url: '/index.php/seracademico/graduacao/turma/diarioAula/edit/' + idDiarioAula,
        datatype: 'json'
    }).done(function (retorno) {
        if (retorno.success) {
            //Limpando os campos
...
$('#btnUpdateDiarioAula').click(function() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/graduacao/turma/diarioAula/update/' + idDiarioAula,
        data: dados,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
