...
$('#btnSaveDisciplinaExtraCurricular').click(function() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: '/index.php/seracademico/posgraduacao/aluno/curriculo/storeDisciplinaExtraCurricular',
        data: dados,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
...
$(document).on('click', '#btnDeleteDisciplinaExtraCurricular', function () {
    ...
    jQuery.ajax({
        type: 'GET',
        url: '/index.php/seracademico/posgraduacao/aluno/curriculo/deleteDisciplinaExtraCurricular/' + idDicilinaExtraCurricular,
        datatype: 'json'
    }).done(function (retorno) {
        if(retorno.success) {
            // Recarregando as grids
