...
function loadTablePlanoAula (idPlanoEnsino) {
    tablePlanoAula = $('#grid-planos-aulas').DataTable({
        ...
        bFilter: false,
        autoWidth: false,
        ajax: "/index.php/seracademico/posgraduacao/planoEnsino/planoAula/grid/" + idPlanoEnsino,
        columns: [
            // {
...
function runPlanoAula(idPlanoEnsino) {
    ...
    if(tablePlanoAula) {
        loadTablePlanoAula(idPlanoEnsino).ajax.url("/index.php/seracademico/posgraduacao/planoEnsino/planoAula/grid/" + idPlanoEnsino).load();
    } else {
...
$(document).on('click', '#btnDestroyPlanoAula', function () {
    ...
    jQuery.ajax({
        type: 'DELETE',
        url: '/index.php/seracademico/posgraduacao/planoEnsino/planoAula/delete/' + idPlanoAula,
        datatype: 'json'
